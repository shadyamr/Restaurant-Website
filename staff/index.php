...
<header class="navbar navbar-dark sticky-top bg-primary flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">
    <img style="background-color:#F8F9FA;border-radius:5px;" src="../components/assets/img/grnd.png" alt="" width="20" class="d-inline-block align-text-top">
    CairoGRND
  </a>
  ...
  <div class="navbar-nav">
    <li class="nav-item dropdown dropstart text-nowrap">
