          ...
          <div class="row align-items-start">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title text-center">
                    <span class="badge rounded-pill bg-secondary"><?php echo $stats->countPendingOrders($conn); ?></span>
                  </h5>
                  <p class="card-text"></p>
                </div>
              </div>
            ...
            <div class="col">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title text-center">
                    <span class="badge rounded-pill bg-secondary"><?php echo $stats->countProcessedOrders($conn); ?></span>
                  </h5>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title text-center">
                    <span class="badge rounded-pill bg-secondary"><?php echo $stats->countCanceledOrders($conn); ?></span>
                  </h5>
                </div>
              </div>
            </div>
